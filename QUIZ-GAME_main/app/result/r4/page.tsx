  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-neutral-200">
      ...
      >
        ...
        >
          <Image src="/r4/IMG_1154.png" alt="Lucky Charm" width={76} height={76} className="absolute left-[9px] top-[8px] w-[76px] h-[76px]" />
        ...
        >
          ...
          <Image src="/r4/IMG_1137.png" alt="Partner" width={80} height={80} className="absolute left-[30px] top-[25px] w-[79px] h-[79px]" />
